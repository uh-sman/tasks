...
const cloudName = publicRuntimeConfig.REACT_APP_CLOUDINARY_CLOUD_NAME as undefined
const cloudPreset = publicRuntimeConfig.REACT_APP_CLOUDINARY_UPLOAD_PRESET as string
