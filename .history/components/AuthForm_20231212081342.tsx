  ...
  return (
    <div>
      <div className="flex">
        ...
        <div className="flex min-h-screen justify-center items-center bg-[#F5E0B8] p-0 w-1/2">
            ...
            <div className="w-72 md:w-[420px] lg:w-[560px] flex-shrink-0 min-w-sm bg-base-100">
              ...
              <form>
                <div className="form-control">
                    <Input id="name" className="block w-full rounded-md border-0 py-1.5 pl-7 pr-2 text-gray-900" placeholder='name'/> 
                </div>
              </form>
            </div>
          </div>
