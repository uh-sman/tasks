...
// const cloudName = publicRuntimeConfig.NEXT_PUBLIC_CLOUDINARY_CLOUD_NAME as string
// const cloudPreset = publicRuntimeConfig.NEXT_PUBLIC_CLOUDINARY_UPLOAD_PRESET as string
