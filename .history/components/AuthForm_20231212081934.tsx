            ...
            <div className="w-72 md:w-[420px] lg:w-[560px] flex-shrink-0 min-w-sm bg-base-100">
              ...
              <form>
                <div className="form-control">
                    <Input id="name" className="block w-full rounded-md border-none py-[12px] pl-7 pr-2 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-gray-100/50 sm:text-sm sm:leading-6" placeholder='name'/> 
                </div>
              </form>
            </div>
          </div>
