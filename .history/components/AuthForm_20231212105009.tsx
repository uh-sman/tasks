        ...
        <div className="flex min-h-screen justify-center bg-[#F5E0B8] p-0 w-1/2">
            ...
            <div className="w-72 md:w-[420px] lg:w-[560px] flex-shrink-0 min-w-sm bg-base-100">
              ...
              <form>
                ...
                <p className="font-semibold text-md">Don`t have an account? <span onClick={ () => setIsLogin('SIGNUP')} className="underline cursor-pointer">signup</span></p>
              </form>
            </div>
            ...
            <div className="w-72 md:w-[420px] lg:w-[560px] flex-shrink-0 min-w-sm bg-base-100">
              ...
              <form>
                ...
                <p className="font-semibold text-md">Don`t have an account? <span onClick={ () => setIsLogin('LOGIN')} className="underline cursor-pointer">signup</span></p>
              </form>
            </div>
          </div>)}
        </div>
