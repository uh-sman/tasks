        ...
        <form onSubmit={() => {}} className="w-full max-w-full">
          ...
          <div className="flex flex-wrap  mb-6">
            <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
              ...
              <input checked id="teal-checkbox" type="checkbox" value="" className="w-6 h-6 text-teal-600 accent-black rounded focus:ring-teal-500 dark:focus:ring-teal-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
              <p className="text-red-500 text-xs italic">
                Please fill out this field.
              </p>
            </div>
