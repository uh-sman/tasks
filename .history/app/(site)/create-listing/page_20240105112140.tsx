        ...
        <form onSubmit={() => {}} className="w-full max-w-full">
          ...
          <div className="flex flex-wrap  mb-6">
            <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
              ...
              <input checked id="checked-checkbox" type="checkbox" value="" className="w-4 h-4 text-white accent-black rounded-2xl border-gray-300 focus:ring-gray-200 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
            ...
            <div className="w-full md:w-1/2 px-3">
              ...
              <Input
                onChange={() => {}}
                // onChange={(value) => handleChange(value, null, "lastname")}
                className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:bor"
                id="lastname"
                type="checkbox"
                placeholder="Enter price"
              />
