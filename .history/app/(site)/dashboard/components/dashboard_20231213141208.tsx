    ...
    <div>
      <div className='lg:w-[315px] w-[200px] h-full min-h-screen fixed top-0 left-0 bg-[#F5E0B8]'>
                <div className='flex flex-col '>
                    <div className='py-4'>
                        <Image src='/images/logo-transparent.png' fill width="45" height='45' alt="Logo" className='bg-[#F5E0B8] w-1/2 h-1/2 mx-auto' />
                        <Image src='/images/logo-slogan.png' fill alt="Logo" width="45" height='45' className='bg-[#F5E0B8] mx-auto mt-1' />
                    </div>
