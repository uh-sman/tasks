...
function CreateAdmin() {
  ...
  const handleRegister = async (e:any) => {
    e.preventDefault()
    try {
      const { firstname, lastname, email, password, confirmpassword, phonenumber, photo } = form
      ...
      // const response = await axios.post('http://localhost:4000/api/superAdmin/register', {
              ...
              <form onSubmit={handleRegister} className="w-full max-w-lg">
                ...
                <div className="flex flex-wrap -mx-3 mb-6">
                  ...
                  <div className="w-full md:w-1/2 px-3">
                    ...
                    <Input
                      onChange={(value) => handleChange(value, null, "phonenumber")}
                      className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                      id="phonenumber"
                      type="text"
                ...
                <div className="flex flex-wrap -mx-3 mb-6">
                  ...
                  <div className="w-full md:w-1/2 px-3">
                    ...
                    <Input
                      ...
                      className={`appearance-none block w-full bg-gray-200 text-gray-700 border  rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 ${passwordMatch ? 'border-red-500' : 'border-gray-200'}`}
                      id="confirmpassword"
                      type="text"
                      placeholder="********"
                    />
                ...
                {
                  passwordMatch ? "passwords don't match" : null
                }
              </form>
            </div>
          </div>
