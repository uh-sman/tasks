                ...
                <div className="form-control space-y-10">
                 {formState === 'SIGNUP' && <Input
                  ...
                  <Input
                    ...
                    id="email"
                    className=" outline-none w-full rounded-md border-none py-[12px] pl-7 pr-2 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset  sm:text-sm sm:leading-6"
                    placeholder="email"
                    type="email"
                  />
                  <Input
